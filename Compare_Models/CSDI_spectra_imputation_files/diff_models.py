...
class diff_CSDI(nn.Module):
    def __init__(self, config, inputdim=2):
        ...
        self.linear_layer1 = nn.Linear(self.channels, self.channels)
        self.linear_layer2 = nn.Linear(self.channels, self.channels)
        self.linear_layer3 = nn.Linear(self.channels, self.channels)
